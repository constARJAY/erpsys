...
class Service_order extends CI_Controller {
    ...
    public function serviceOrderExcel($data) {
        ...
        $sheet->setCellValue('A6', getFormCode("SO", $data["createdAt"], $data["serviceOrderID"]));
        $sheet->getStyle('A6')->applyFromArray($documentNoStyle);
        $sheet->mergeCells('A7:K7');
        $sheet->setCellValue('A7', "SERVICE ORDER");
        ...
        $sheet->setCellValue('H11', "Schedule: ");
        $sheet->mergeCells('J11:K11');
        $sheet->setCellValue('J11', $data["scheduleDate"]);
        ...
        $sheet->setCellValue('C13', "Scope of work");
