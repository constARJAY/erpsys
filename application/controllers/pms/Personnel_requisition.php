...
class Personnel_requisition extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view("pms/personnel_requisition/index");
    ...
    public function savePersonnelRequisition()
    {
        ...
        $purchaseRequestData = [
            ...
            "personnelDateNeeded"   => $personnelDateNeeded,
            "personnelStatement"   => $personnelStatement,
