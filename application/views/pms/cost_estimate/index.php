        ...
        <div class="container" id="headerContainer">
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6">
                    ...
                    <h1 class="mt-3">Cost Estimate</h1>
                    <span>This module is used to manage the submission and approval of cost estimates.</span>
                </div>
...
<script src="<?= base_url('assets/custom/js/pms/cost-estimate.js') ?>"></script>