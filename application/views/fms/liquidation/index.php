        ...
        <div class="container" id="headerContainer">
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6">
                    ...
                    <h1 class="mt-3">List of Liquidations</h1>
                    <span>This module is used to liquidation form details.</span>
                </div>
                <div class="col-lg-6 col-md-6 text-right" id="headerButton">
				<button type="button" class="btn btn-default btn-add" id="btnAdd" data-toggle="tab" href="#addPR"><i class="icon-plus"></i> &nbsp;Add Liquidation</button></div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row px-2">
                                <div class="col-lg-2 col-md-6 col-sm-12 px-1">
                                    <div class="card">
                                        <div class="body">
                                            <small class="text-small text-muted font-weight-bold">Liquidation No.</small>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Liquidation Type <code>*</code></label>
                                        <!-- <input type="text" class="form-control" disabled value=""> -->
                                         <select class="form-control validate select2"
                                            ...
                                            style="width: 100%"
                                            required>
                                            <option selected disabled>Select Type of Liquidation</option>             
                                        </select> 
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label>Purpose <code>*</code></label>
                                            <textarea rows="4" style="resize: none" class="form-control" name="purpose" id="input_Purpose" data-allowcharacters="[a-z][A-Z][0-9][ ][.][,][-][()]['][/][&]"></textarea>
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="offset-md-8 col-md-4 col-sm-12 pt-3 pb-2 mt-4">
                                    ...
                                    <div class="row" style="font-size: 1.1rem; font-weight:bold">
                                        <div class="col-6 text-right">Budget: </div>
                                        <div class="col-6 text-right">
                                            <input type="text" class="form-control-plaintext amount py-0 text-danger font-weight-bold" min="0" max="9999999999" minlength="1" maxlength="20" name="vat" id="vat" style="font-size: 1.02em; text-align: right;" value="0.00" disabled="">
                                        </div>
                                    </div>
                                    <div class="row" style="font-size: 1.1rem; font-weight:bold">
                                        <div class="col-6 text-right">Excess/Shortage:</div>
                                        <div class="col-6 text-right text-danger" id="excessShortage" style="font-size: 1.02em">
                                            0.00
                                        </div>
                                    </div>
                                </div>
