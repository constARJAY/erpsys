            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6">
                    <ul class="breadcrumb pl-0 pb-0 ">
                        ...
                        <li class="breadcrumb-item active">Petty Cash Replenishment</li>
                    </ul>
                    <h1 class="mt-3">Petty Cash Replenishment Form</h1> 
                    <span>This module is used to manage the submission and approval of petty cash replenishment.</span>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
		<div class="modal-content">
			<div class="modal-header bg-primary text-light">
				<h6 class="page-title font-weight-bold">DENY PETTY CASH REPLENISHMENT</h6>
...
<script src="<?= base_url('assets/custom/js/fms/petty-cash-replenishment.js') ?>"></script>