        ...
        <div class="container" id="headerContainer">
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6">
                    ...
                    <h1 class="mt-3">Payment Request</h1>
                    <span>This module is used to manage the submission and approval of payment request.</span>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
		<div class="modal-content">
			<div class="modal-header bg-primary text-light">
				<h6 class="page-title font-weight-bold">ADD PAYMENT REQUEST</h6>
...
<script src="<?= base_url('assets/custom/js/fms/payment-request.js') ?>"></script>
<script>
