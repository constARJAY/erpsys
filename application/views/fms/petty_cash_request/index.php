    ...
    <div class="block-header pb-0">
        <div class="container" id="headerContainer">
            <div class="row clearfix">
				...
				<button type="button" class="btn btn-default btn-add" id="btnAdd" data-target="#"><i class="icon-plus"></i> &nbsp;Add Petty Cash Request</button></div>
            </div>
		...
		<div class="row clearfix row-deck mx-1">
            <div class="card col-12" id="addRequest">
                ...
                <div class="col-sm-12">
                    <div class="w-100">
                        <hr class="pb-1">
                        <div class="text-primary font-weight-bold" style="font-size: 1.5rem;">Petty Cash Request Vouchers</div>
                        <table class="table table-striped" id="pcrDetails">
                            <thead>
                                <tr style="white-space: nowrap">
                                    ...
                                    <th>Chart of Account <code>*</code></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="description">
                                            <textarea rows="2" style="resize: none" class="form-control" name="description" id="description"></textarea>
                                        </div>
                                    </td>
                                    <td>
