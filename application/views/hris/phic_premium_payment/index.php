        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-sm-12 col-md-10">
                    ...
                    <h1 class="mt-3">List of PHIC Premium Payment</h1>
                    <span>This module is used to generate and monitor the PHIC premium payment for each month.</span>
                </div>
...
<!-- ----- ADD MODAL ----- -->
<div id="modal_PHIC" class="modal custom-modal fade" data-backdrop="static" data-keyboard="false" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header bg-primary text-light">
				<h5 class="page-title font-weight-bold modal_PHIC_header">ADD AWARD</h5>
				<button type="button" class="close btnCancel" data-dismiss="modal" aria-label="Close">
					<span class="text-light" aria-hidden="true">&times;</span>
				</button>
			</div>

            <div id="modal_PHIC_content">
...
<script src="<?=base_url("assets/custom/js/hris/phic-premium-payment.js")?>"></script>