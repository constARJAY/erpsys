...
<body>
    ...
    <table style="width:100%;border-collapse: collapse;">
        <thead>
            <tr>
                <th colspan="2">
                            <img src="<?=base_url("assets/images/mandates-logo/philhealth.jpg")?>" height="50px" width="100px"  alt="SSS IMAGE" >
                            
                </th>
                <th colspan="6" style="font-size:70%; text-align:center">
                        <small><small>Republic of the Philipines</small></small><br>
                        <small>PHILIPINE HEALTH INSURANCE CORPORATION</small><br>
                        <small><small>www.philhealth.gov.ph</small></small><br><br>
                ...
                <th colspan="1">
                        <table style="font-size:70%; width:100%; ">
                            <thead>
                                <tr>
                                    <th style="text-align:center;" class="border">Employer TIN</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                ...
                <th colspan="1">
                        <table style="font-size:70%; width:100%; ">
                            <thead>
                                <tr>
                                    <th style="text-align:center;" class="border">PhilHealth NUMBER</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
        ...
        <tbody style="font-size:80%;">
            ...
            <?php 
                ...
                foreach ($reportData as $key => $value):
                    $deduction  = $value["phicDeduction"] == "0.00" ? "0.00" : $value["phicDeduction"];
                    $employer   = $value["phicDeduction"] == "0.00" ? "0.00" : $value["phicEmployer"];
            ...
            ?>
                <tr>
                    ...
                    <td class="border text-center"><?=$value["employeePhilHealth"]?></td>
                    <td class="border text-center"><?=$value["employeeLastname"]?></td>
                    <td class="border text-center"><?=$value["employeeFirstname"]?></td>
                    <td class="border text-center"><?=$value["employeeMiddlename"]?></td>
                    ...
                    <td colspan="2" class="border text-right"> </td>
                </tr>
            <?php endforeach;?>
            <!-- END EMPLOYEE DATA -->

            <tr>
                <td class="border" colspan="5">Sub-Total</td>
            ...
            <tr style="">
                <td class="border" colspan="5">GRAND TOTAL</td>
                <td colspan="4" class="border text-right"><?=formatAmount($grandTotal, true)?></td>
