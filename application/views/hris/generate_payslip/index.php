		...
		<div class="container" id="headerContainer">
			<div class="row clearfix">
				<div class="col-lg-6 col-md-12">
					...
					<h1 class="mt-3">Generate Payslip</h1>
					<span>This module is used to generate payslips for each employee.</span>
				</div>
			</div>
		</div>
	</div>
...
<!-- ----- ADD MODAL ----- -->
<div id="modal_generate_payslip" class="modal custom-modal fade" data-backdrop="static" data-keyboard="false" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
		<div class="modal-content">
			<div class="modal-header bg-primary text-light">
				<h5 class="page-title font-weight-bold">Add Generate Payslip</h5>
				<button type="button" class="close btnCancel" data-dismiss="modal" aria-label="Close">
					<span class="text-light" aria-hidden="true">&times;</span>
				</button>
			</div>
            <div id="modal_generate_payslip_content"></div>
        </div>
	</div>
</div>
<!-- ----- END ADD MODAL ----- -->
...
<script src="<?=base_url()?>assets/custom/js/hris/generate-payslip.js"></script>