			...
			<div class="row clearfix">
				<div class="col-lg-6 col-md-12">
					<ul class="breadcrumb pl-0 pb-0 ">
						...
						<li class="breadcrumb-item d-flex align-items-center"><a href="#"><i class="zmdi zmdi-settings"></i> Masterfile</a></li>
						<li class="breadcrumb-item active"> Orientation Setup</li>
					</ul>
					<h1 class="mt-3">Orientation Setup</h1>
					<span>This module is used to manage orientation setup details</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal_approval_setup_content">
					<div class="modal-body modal-bodytable">		
		</div>
	</div>
</div>
</div>
