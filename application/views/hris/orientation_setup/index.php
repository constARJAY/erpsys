			...
			<div class="row clearfix">
				<div class="col-lg-6 col-md-12">
					<ul class="breadcrumb pl-0 pb-0 ">
						...
						<li class="breadcrumb-item active"> Orientation Setup</li>
					</ul>
					<h1 class="mt-3">Orientation Setup</h1>
					<span>This module is used to manage the setup for orientations.</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog modal-dialog-centered modal-min" role="document">
		<div class="modal-content">
			...
			<img class="isometric confirmationisometric" width="230px" height="200px" style="text-align: center" src="<?=base_url(); ?>assets/modal/update.png">
				...
				<p class="text-center my-2">Are you sure that you want to update the orientation setup for this designation?</p>
			</div>
			<div class="modal-footer">
				<div class="w-100 text-right">
...
<div id="modal_orientation_setup" class="modal custom-modal fade" data-backdrop="static" data-keyboard="false"
	...
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header bg-primary text-light">
				<h5 class="page-title font-weight-bold">ORIENTATION SETUP</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span class="text-light" aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal_orientation_setup_content">
...
<script src="<?= base_url('assets/custom/js/hris/orientation-setup.js') ?>"></script>
