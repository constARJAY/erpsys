...
<!-- ----- ADD MODAL ----- -->
<div id="modal_payroll_register" class="modal custom-modal fade" data-backdrop="static" data-keyboard="false" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
		<div class="modal-content">
            ...
            <div id="modal_payroll_register_content"></div>
        </div>
	</div>
</div>
<!-- ----- END ADD MODAL ----- -->
...
<script src="<?=base_url()?>assets/custom/js/hris/payroll-register.js"></script>