		...
		<div class="container" id="headerContainer">
			<div class="row clearfix">
				<div class="col-lg-6 col-md-12">
					...
					<h1 class="mt-3">Payroll Adjustment Report</h1>
					<span>This module is used to generate and monitor approved payroll adjustments.</span>
				</div>
...
<script src="<?=base_url()?>assets/custom/js/hris/payroll-adjustment-report.js"></script>