        ...
        <div class="container" id="headerContainer">
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6">
                    ...
                    <h1 class="mt-3">13th Month Report</h1>
                    <span>This module is used to generate and monitor approved 13th month documents.</span>
                </div>
...
<script src="<?= base_url('assets/custom/js/hris/month-process-report.js') ?>"></script>
<script>
