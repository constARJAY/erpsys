        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-sm-12 col-md-10">
                    ...
                    <h1 class="mt-3">List of HDMF Premium Payment</h1>
                    <span>This module is used to generate and monitor the HDMF premium payment for each month.</span>
                </div>
...
<script src="<?=base_url("assets/custom/js/hris/hdmf-premium-payment.js")?>"></script>