		...
		<div class="container" id="headerContainer">
			<div class="row clearfix">
				<div class="col-lg-6 col-md-12">
					...
					<h1 class="mt-3">Payroll Report</h1>
					<span>This module is used to generate and monitor approved payrolls.</span>
				</div>
...
<!-- ----- ADD MODAL ----- -->
<div id="modal_payroll_report" class="modal custom-modal fade" data-backdrop="static" data-keyboard="false" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
		<div class="modal-content">
            ...
            <div id="modal_payroll_report_content"></div>
        </div>
	</div>
</div>
<!-- ----- END ADD MODAL ----- -->
...
<script src="<?=base_url()?>assets/custom/js/hris/payroll-report.js"></script>