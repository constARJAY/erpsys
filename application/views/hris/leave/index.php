        ...
        <div class="container">
            <div class="row clearfix">
                ...
                <div class="col-4 d-flex justify-content-end align-items-center">
                    <button class="btn btn-default btn-add ml-2 d-flex justify-content-center align-items-center addLeave"><i class="icon-plus px-2"></i> <span class="d-none d-sm-none d-md-block d-lg-block d-xl-block">Add&nbsp;</span> Leave Type</button>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?=base_url("assets/custom/js/hris/leave.js")?>"></script>