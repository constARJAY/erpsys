			...
			<div class="row clearfix">
				<div class="col-lg-6 col-md-12">
					<ul class="breadcrumb pl-0 pb-0 ">
						...
						<li class="breadcrumb-item active"  id="inv_mainItem_breadcrumbs">Inventory Category</li>
                        <!-- <li class="breadcrumb-item" id="inv_item_breadcrumbs" style="visibility:hidden;"><i class="icon-social-dropbox" ></i> &nbsp;Add Category</li> -->
					</ul>
					<h1 class="mt-3" id="inv_headerID">List of Inventory Category</h1>
...
<script src="<?=base_url()?>assets/custom/js/ims/inventory-category.js"></script>