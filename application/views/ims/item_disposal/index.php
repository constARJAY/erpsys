...
<!-- ----- MODAL ----- -->
<div id="modal_item_disposal" class="modal custom-modal fade" data-backdrop="static" data-keyboard="false" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
		<div class="modal-content">
            ...
            <div id="modal_item_disposal_content"></div>
        </div>
	</div>
</div>
<!-- ----- END MODAL ----- -->
...
<script src="<?= base_url('assets/custom/js/gen/approver-function.js') ?>"></script>
 <script src="<?= base_url('assets/custom/js/ims/item-disposal.js') ?>"></script> 