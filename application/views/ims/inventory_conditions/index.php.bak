			...
			<div class="row clearfix">
				<div class="col-lg-6 col-md-12">
					<ul class="breadcrumb pl-0 pb-0 ">
						...
						<li class="breadcrumb-item active"  id="invMainConditionsBreadcrumbs"><i class="fa fas-users"></i> &nbsp;Inventory Item Conditions</li>
                        <li class="breadcrumb-item" id="invConditionsBreadcrumbs" style="visibility:hidden;"> Add Status</li>
					</ul>
					<h1 class="mt-3" id="invConditionsHeaderID">List of Inventory Item Conditions</h1>
...
<!-- ----- ADD MODAL ----- -->
<div id="modalInventoryConditions" class="modal custom-modal fade" data-backdrop="static" data-keyboard="false" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header bg-primary text-light">
				<h5 class="page-title font-weight-bold" id="modalTitleAddConditionsHeader">ADD CONDITIONS</h5>
				<button type="button" class="close btnCancel" data-dismiss="modal" aria-label="Close">
					<span class="text-light" aria-hidden="true">&times;</span>
				</button>
			</div>

            <div id="modalInventoryConditionsContent"></div>
        </div>
	</div>
</div>
<!-- ----- END ADD MODAL ----- -->
