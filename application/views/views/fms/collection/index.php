        ...
        <div class="container" id="headerContainer">
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6">
                    ...
                    <h1 class="mt-3">List of Collections</h1>
                    <span>This module is used to manage collection details.</span>
                </div>
                <div class="col-lg-6 col-md-6 text-right" id="headerButton">
				<button type="button" class="btn btn-default btn-add" id="btnAdd" data-toggle="tab" href="#addPR"><i class="icon-plus"></i> &nbsp;Add Collection</button></div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row px-2">
                                <div class="col-lg-2 col-md-6 col-sm-12 px-1">
                                    <div class="card">
                                        <div class="body">
                                            <small class="text-small text-muted font-weight-bold">Collection No.</small>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <label>Client Code <code>*</code></label>
                                        <select class="form-control select2 validate"
                                            name="clientCode"
                                            id="clientCode"
                                            required>
                                            <option selected disabled>Select Client Code</option>
                                        </select>
                                        <div class="invalid-feedback d-block" id="invalid-clientCode"></div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 validate"
                                            ...
                                            id="formOfPayment"
                                            required>
                                            <option selected disabled>Select Form of Payment</option>
                                        </select>
                                        <div class="invalid-feedback d-block" id="invalid-formOfPayment"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 pt-3 pb-2 mt-4">
                                    <div class="row" style="font-size: 1.1rem; font-weight:bold">
                                        ...
                                        <div class="col-6 text-right">
                                            <input type="text" class="form-control-plaintext amount py-0 font-weight-bold" min="0" max="9999999999" minlength="1" maxlength="20" name="vat" id="vat" style="font-size: 1.02em; text-align: right;" value="0.00" disabled="">
                                        </div>
                                    </div>
                                    <div class="row" style="font-size: 1.1rem; font-weight:bold">
                                        <div class="col-6 text-right">Vat 12%:</div>
                                        <div class="col-6 text-right">
                                            <input type="text" class="form-control-plaintext amount py-0 border-bottom font-weight-bold" min="0" max="9999999999" minlength="1" maxlength="20" name="vat" id="vat" style="font-size: 1.02em; text-align: right;" value="0.00" disabled="">
                                        </div>
                                    </div>
                                    <div class="row" style="font-size: 1.1rem; font-weight:bold">
