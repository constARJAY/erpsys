                        ...
                        <div class="row" id="page_content">
                            ...
                            <div class="col-12">
                                <div class="form-group inner-addon left-addon">
                                    ...
                                    <input type="text" tabindex="1" class="form-control login-input validate" data-allowcharacters="[a-z][A-Z][0-9][ ][,][.][@][-][_]" minlength="5" maxlength="50" type="text" id="applicantUsername" autocomplete="off" placeholder="Username">
                            ...
                            <div class="col-12">
                                <div class="form-group inner-addon left-addon">
                                    ...
                                    <input type="password" tabindex="2" class="form-control login-input validate" data-allowcharacters="[a-z][A-Z][0-9][ ][,][.][@][-][_]" minlength="5" maxlength="50" type="password" id="applicantPassword" placeholder="Password">
