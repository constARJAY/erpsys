...
<script>
    ...
    $(document).ready(function() {
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    maxlength="20"  
                                    value="${firstname}">
                                <div class="invalid-feedback d-block" id="invalid-input_firstname"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    required 
                                    value="${lastname}">
                                <div class="invalid-feedback d-block" id="invalid-input_lastname"></div>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    value="${email}">
                                <div class="invalid-feedback d-block" id="invalid-input_email"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    required 
                                    value="${mobile}">
                                <div class="invalid-feedback d-block" id="invalid-input_mobile"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    required 
                                    value="${telephone}">
                                <div class="invalid-feedback d-block" id="invalid-input_telephone"></div>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    required 
                                    value="${address}">
                                <div class="invalid-feedback d-block" id="invalid-input_address"></div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    id="input_gender" 
                                    value="Male" 
                                    ${data ? (gender == "Male" ? "checked" : "") : "checked"}> 
                                    &nbsp;Male&nbsp; 
                                <input 
                                    type="radio" 
                                    class="" 
                                    ...
                                    &nbsp;Female&nbsp;
                                <div class="invalid-feedback d-block" id="invalid-input_gender"></div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <select 
                                    ...
                                    <option 
                                        value="" 
                                        disabled 
                                        ${!data && "selected"}>Select Role</option>
                                    <option 
                                        value="Admin" 
                                        ${data && role == "Admin" && "selected"}>Admin</option>
                                    <option 
                                        value="Operations" 
                                        ${data && role == "Operations" && "selected"}>Operations</option>
                                </select>
                                <div class="invalid-feedback d-block" id="invalid-input_role"></div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input 
                                        ...
                                        id="input_birthday" 
                                        required 
                                        value="${data && birthday ? moment(birthday).format("MMM DD, YYYY") : ""}">
                                </div>
                                <div class="invalid-feedback d-block" id="invalid-input_birthday"></div>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    required 
                                    value="${link}">
                                <div class="invalid-feedback d-block" id="invalid-input_link"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    unique="${userAccountID}" 
                                    value="${username}">
                                <div class="invalid-feedback d-block" id="invalid-input_username"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    required 
                                    value="${password}">
                                <div class="invalid-feedback d-block" id="invalid-input_password"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    id="input_skills" 
                                    value="CSS" 
                                    ${data && skills && skills.some(x => x == "CSS") ? "checked" : ""}> CSS 
                                <input 
                                    type="checkbox" 
                                    name="skills" 
                                    id="input_skills" 
                                    value="HTML" 
                                    ${data && skills && skills.some(x => x == "HTML") ? "checked" : ""}> HTML 
                                <input 
                                    type="checkbox" 
                                    name="skills" 
                                    id="input_skills" 
                                    value="JS" 
                                    ${data && skills && skills.some(x => x == "JS") ? "checked" : ""}> JS 
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    max="100000"
                                    value="${currency}">
                                <div class="invalid-feedback d-block" id="invalid-input_amount"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    required
                                    multiple>
                                <div class="invalid-feedback d-block" id="invalid-input_file"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $(document).on("click", ".btnEdit", function() {
            ...
            const tableData = getTableData("gen_operations_tbl", "*", "userAccountID="+id, "");
            if (tableData) {
        ...
        $(document).on("click", "#btnSaveConfirmationAdd", function() {
            ...
            data.append("tableName", "gen_operations_tbl");
        ...
        $(document).on("click", ".btnCloseConfirmationDelete", function() {
            $("#confirmation-modal_delete_user_account").modal("hide");
        })
