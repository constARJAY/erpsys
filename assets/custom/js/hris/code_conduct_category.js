                                                    ...
                                                    <div class="row"> 
                                                        ...
                                                        <div class="col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2 validate" name="codeConductCategoryStatus" id="inputcodeConductCategoryStatus" required>
...
$(document).on("click", "#btnSave", function(){
    ...
    if(condition == true){
        let tableData           = getTableData("hris_code_conduct_category_tbl","","","codeConductCategoryID DESC");
        ...
        // Generate Number
        let tableDataCode       = tableData.length < 1 ? "" : parseInt(tableData[0]["codeConductCategoryID"].slice(6)) + 1;

        let codeConductCategoryID  = tableData.length < 1 ? "LVE-"+currentYearStr.slice(2)+"-00001" : "LVE-"+currentYearStr.slice(2)+"-"+numberCodeSize(tableDataCode, "5");

        let data = getFormData("modal_codeConductCategory_form", true);
        data["tableData[codeConductCategoryID]"]     = codeConductCategoryID;
        data["tableData[createdBy]"]     = "1";
        data["tableData[updatedBy]"]     = "1";
        data["tableName"]                = "hris_code_conduct_category_tbl";
        data["feedback"]                 = codeConductCategoryID;
        sweetAlertConfirmation("add", "Code of Conduct Category Masterfile","modal_codeConductCategory", null, data);
    }
});
...
$(document).on("click", "#btnUpdate", function(){
    ...
    if(condition == true){
        ...
        sweetAlertConfirmation("update", "Code of Conduct Category","modal_codeConductCategory", null , data);
    }
    
});

$(document).on("click","#btnCancel", function(){
    let condition = emptyFormCondition("modal_codeConductCategory_form");
    if(condition == true){
        sweetAlertConfirmation("", "Code of Conduct Category Masterfile","modal_codeConductCategory");
    }else{
