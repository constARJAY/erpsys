...
$(document).on("change","#select2-modules", function(){
    ...
    let approvalDesignation    =  getTableData("gen_approval_setup_tbl","","moduleID="+thisValue);
...
$(document).on("click","#btn-approval_designation", function(){
    ...
    $(".position-list").html(preloader);
    let position_list   =   "";
    let approvalDesignation    =  getTableData("gen_approval_setup_tbl","","moduleID="+thisModuleID, "designationID ASC");
    if(approvalDesignation.length > 0){
...
$(document).on("click", "#cancel_attach-designation", function(){
    ...
    let approvalDesignation    =  getTableData("gen_approval_setup_tbl","","moduleID="+thisValue, "designationID ASC");
...
$(document).on("click", ".designation-list", function(){
    ...
    $(".approval-list").html(preloader);
    setTimeout(function(){ getApproval(moduleID,designationID);  }, 500);
...
function viewAttachDesignation(moduleID = null){
    if(moduleID == null){
        ...
        let returnData      =   "";
        let approvalDesignation    =  getTableData("gen_approval_setup_tbl","","moduleID="+moduleID, "designationID ASC");
...
function getApproval(moduleID = null,designationID = null){
    ...
    let approval        = getTableData("gen_approval_setup_tbl", "", "moduleID = '"+moduleID+"' AND designationID = '"+designationID+"' "); // RESULT 0/ 1|2|3;
