$(document).ready(function() {
    ...
    function getTotalExpense() {
        const tableName = "hall_list_tbl";
        const tablePK = $("#hallno").attr("hallid");
        $.ajax({
            method: "POST",
    ...
    $(document).on("click", "#btn_save_confirmation_add", function() {
        let data = getExpenseData("add");
            data.tableName = "hall_list_tbl";
            data.tablePK   = $("#hallno").attr("hallid");
    ...
    function getCostManagementByCode(code, todo) {
        $.ajax({
            ...
            async:    false,
            data:     {expenseCode: code, tableName: "hall_list_tbl"},
            dataType: "json",
            success: function(data) {
                data.map(item => {
