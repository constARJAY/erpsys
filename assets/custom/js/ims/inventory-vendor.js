$(document).ready(function(){
    ...
    $(document).on("click", "#btnAdd", function() {
        $("#modalTitleAddVendorHeader").text("ADD VENDOR");
        $("#modalInventoryVendor").modal("show");
        $("#modalInventoryVendorContent").html(preloader);
        const content = modalContent();
        $("#modalInventoryVendorContent").html(content);
        initAll();
    });
    // ----- END OPEN ADD MODAL -----
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label>Supplier Code <span class="text-danger font-weight-bold">*</span></label>
                            <input 
                            type="text" 
                            ...
                            value=""
                            autocomplete="off">
                            <div class="invalid-feedback d-block" id="invalidInputSupplierCode"></div>
                        </div>
                    </div>
                    <div class="col-xl-9 col-lg-8 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label>Supplier Name <span class="text-danger font-weight-bold">*</span></label>
                            <input 
                                type="text" 
                                class="form-control validate" 
                                name="supplierName" 
                                ...
                                value=""
                                autocomplete="off">
                            <div class="invalid-feedback d-block" id="invalidInputSupplierName"></div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            <label>Region</label>
                            <select class=" form-control show-tick select2 validate" name="region" oldRegion=""
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <select class=" form-control show-tick select2 validate" name="province" oldProvince=""
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            <label>City</label>
                            <select class=" form-control show-tick select2" id="city" name="city" readonly="" oldCity=""></select> 
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            ...
                            <select class=" form-control show-tick select2 validate" name="barangay" oldBarangay=""
                    ...
                    <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label>Brand Name <small class="text-muted">(Optional)</small></label>
                            <input 
                                type="text" 
                                class="form-control validate" 
                                name="brandName" 
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label>VAT <span class="text-danger font-weight-bold">*</span></label>
                    ...
                    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select class=" form-control show-tick select2 validate" name="status" id="status" autocomplete="off" title="Select Status" required>
    ...
    const validate = validateForm("modalInventoryVendor");
    if (validate) {
        $("#modalInventoryVendor").modal("hide");
        Swal.fire({
            title: 'Are you sure?',
    ...
    // -------- END CANCEL MODAL-----------
      ...
      function initDataTables() {
        ...
        var table = $("#tableInventoryVendor").css({"min-width": "100%"}).removeAttr('width').DataTable({
            proccessing:    false,
            serverSide:     false,
            scrollX:        true,
            scrollCollapse: true,
